...
--  
/*
 * Title:        CloudSim exp 3. Done by Praveen Saravanan, W1
 * Description:   A simple example showing how to create a datacenter with one host and run 
 * two cloudlets on it. The cloudlets run in VMs with the same MIPS requirements.
...
<img width="1678" height="1196" alt="image" src="https://github.com/user-attachments/assets/e61ba740-6ba0-4cb4-877a-da8a7336b109" />
